...
public final class QueryUtils {
     ...
     */
    public static ArrayList<Earthquake> extractEarthquakes(JSONObject jsonObject) {
        ...
        try {
            ...
            JSONObject jsonRootObject = jsonObject;
